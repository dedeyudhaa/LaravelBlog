...
Route::prefix('author')->name('author.')->group(function() {
    ...
    Route::middleware(['auth:web'])->group(function(){
        ...
        Route::post('/change-profil-picture', [AuthorController::class, 'changeProfilePicture'])->name('change-profile-picture');
        
        
        
        //HANYA ADMIN YG BISA AKSES
        ...
        Route::prefix('posts')->name('posts.')->group(function(){
            ...
            Route::view('/all','back.pages.all_post')->name('all_post');
